...
const translations = {
  ...
  ku: {
    "meta.home.title":
      "نەجمەدین ئار ئێم ئێکس | ئایندەی عێراق دروست دەکەین لە 2002ەوە",
    "meta.home.description":
      "کۆمپانیای نەجمەدین ئار ئێم ئێکس لە ساڵی ٢٠٠٢ دامەزراوە، و یەکێکە لە کۆمپانیا پێشەنگەکان لە بەرهەمهێنان و دابینکردنی کۆنکریتی ئامادە و چەو و لم لە هەرێمی کوردستانی عێراق.",
    "meta.about.title": "دەربارەی نەجمەدین ئار ئێم ئێکس",
    "meta.about.description":
      "زیاتر بزانە لەسەر نەجمەدین ئار ئێم ئێکس، مێژووی زیاتر لە 20 ساڵی، بنەماکانی کارکردن، و پابەندی بە کوالێتی و سەلامەتی و گەیاندنی باوەڕپێکراو.",
    "meta.services.title": "خزمەتگوزارییەکان | نەجمەدین ئار ئێم ئێکس",
    "meta.services.description":
      "خزمەتگوزارییەکانی نەجمەدین ئار ئێم ئێکس ببینە؛ لە بەرهەمهێنانی کۆنکریتی ئامادە و دیزاینی تێکەڵە تا دابینکردنی چەو و لم و ڕاوێژی تەکنیکی.",
    "meta.projects.title": "پڕۆژەکان | نەجمەدین ئار ئێم ئێکس",
    "meta.projects.description":
      "پڕۆژە و بڵێندراوە ناوازەکان ببینە کە لەلایەن نەجمەدین ئار ئێم ئێکس پشتیوانی کراون لە هەرێمی کوردستانی عێراق.",
    "meta.clients.title": "کڕیارەکان | نەجمەدین ئار ئێم ئێکس",
    "meta.clients.description":
      "نەجمەدین ئار ئێم ئێکس پشتگیری گەورەترین پەرەپێدەران و براندە هوتێلییەکان و پڕۆژە ستراتیژییەکان دەکات لە ناوچەکەدا.",
    "meta.contact.title": "پەیوەندی | نەجمەدین ئار ئێم ئێکس",
    "meta.contact.description":
      "بۆ پرسیارەکانی پڕۆژە و داواکارییەکانی دابینکردنی کۆنکریت و پشتگیری تەکنیکی پەیوەندی بە نەجمەدین ئار ئێم ئێکس بکە.",
    "common.home_label": "ماڵپەڕی سەرەکیی نەجمەدین ئار ئێم ئێکس",
    ...
    "common.stats.years": "ساڵ لە کارکردن لە ٢٠٠٢ەوە",
    "common.stats.people": "کارمەندی لێهاتوو",
    ...
    "footer.rights": "نەجمەدین ئار ئێم ئێکس. هەموو مافەکان پارێزراون.",
    "footer.navigation": "ڕێنیشاندەر",
    "footer.contact": "پەیوەندی",
    "home.hero.eyebrow": "دابینکەری سەرەکیی کۆنکریتی ئامادە و چەو و لم لە هەرێمی کوردستانی عێراق",
    "home.hero.title": "ئایندەی عێراق دروست دەکەین لە 2002ەوە",
    "home.hero.body":
      "نەجمەدین ئار ئێم ئێکس کۆنکریتی ئامادە و تێکەڵە و پشتگیری تەکنیکی و لۆجستی تایبەتی بۆ پڕۆژە گەورەکان دابین دەکات لە هەموو ناوچەکەدا.",
    ...
    "home.hero.panel3.body": "بەرهەمی تەواو ناوخۆیی بە پشتگیری تەکنیکی ڕێکخراو.",
    "home.story.eyebrow": "بۆچی نەجمەدین ئار ئێم ئێکس",
    "home.story.title": "هێزی پیشەسازی. وردیی ناوخۆ.",
    "home.story.visual1": "هێزی پیشەسازی.",
    "home.story.visual2": "وردیی ناوخۆ.",
    "home.story.body":
      "لە ساڵی 2002ەوە، نەجمەدین ئار ئێم ئێکس گەشەی کردووە بۆ ئەوەی ببێتە یەکێک لە کۆمپانیا پێشەنگەکان لە بەرهەمهێنان و دابینکردنی کۆنکریتی ئامادە و چەو و لم. ناوبانگمان لەسەر کوالێتی پشتپێبەستوو و گەیاندنی لەکاتی خۆیدا و توانای تەکنیکییە کە پشتیوانی پڕۆژەکان دەکات.",
    "home.story.quote":
      "کۆنکریت تەنها تێکەڵەیەک نییە؛ چارەسەرێکی فرەمەبەستە کە بە توندی بە کڕیارانمانەوە دەمانبەستێتەوە.",
    "home.about.title": "دوو دەیە لە بنیاتنانی ژێرخانی کوردستان",
    "home.about.body":
      "کۆمپانیای نەجمەدین ئار ئێم ئێکس لە ساڵی ٢٠٠٢ دامەزراوە، و یەکێکە لە کۆمپانیا پێشەنگەکان لە بەرهەمهێنان و دابینکردنی کۆنکریتی ئامادە و چەو و لم. ئەرکمان دابینکردنی بەرهەمی کوالێتی بەرزە بۆ کڕیارانمان. نهێنی پێشکەشکردنی کۆنکریتی ئامادەی کوالێتی بەرز لە چاودێریکردنی وردی کوالێتی و بەکارهێنانی کەرەستەی کوالێتی بەرزدایە، ئەمەش وایکردووە ناوبانگێک وەک دابینکەرێکی جێی متمانە بەدەست بهێنین.",
    "home.vision.eyebrow": "دیدگامان",
    ...
    "home.vision.card1.title": "داهێنان و کوالێتی",
    "home.vision.card1.body":
      "کوالێتییەکی بێوێنە لە ڕێگەی نوێترین تەکنیکەکانەوە دابین دەکەین. ئێمە نوێترین داهێنانەکان بەکاردەهێنین بۆ مسۆگەرکردنی لوتکەی کوالێتی و پتەوی.",
    "home.vision.card2.title": "گەیاندن لە کاتی گونجاودا",
    "home.vision.card2.body":
      "مسۆگەری گەیاندن لە کاتی دیاریکراودا و گەیاندن بۆ دوورەدەستترین ناوچەکان دەکەین. تیمی لۆجستی ئێمە گەیاندنی دەستبەجێ مسۆگەر دەکات بۆ پاراستنی خشتەی کاتی پڕۆژەکان.",
    "home.vision.card3.title": "بەرەوپێشچوونی بەردەوام",
    "home.vision.card3.body":
      "هەمیشە هەوڵی بەرەوپێشچوون دەدەین بۆ بەدەستهێنانی بەرهەمی کوالێتی بەرز. بەردەوام کار دەکەین بۆ باشترکردنی پرۆسەکانمان بۆ ئەوەی پێوەرەکانی پیشەسازییەکە تێپەڕێنین.",
    "home.action.project.title": "پڕۆژە",
    "home.action.project.body":
      "پڕۆژە دیارەکان ببینە کە نەجمەدین ئار ئێم ئێکس لە هەرێمی کوردستاندا دابینی کردوون.",
    "home.action.service.title": "خزمەتگوزاری",
    "home.action.service.body":
      "چارەسەری کۆنکریتی ئامادە و چەو و لم و گەیاندن بۆ شوێنە دوورەکان بۆ هەموو پلەیەک.",
    ...
    "home.services.body":
      "لە کۆنکریتی ئامادەی ئاستی بەرهەمهێنان تا دابینکردنی چەو و لم و ڕێنمایی تەکنیکی، تیمەکانمان پشتگیری کارکردن دەکەن لە کارگەکەوە تا شوێنی پڕۆژەکە.",
    "home.services.card1.title": "کۆنکریتی ئامادە",
    "home.services.card1.body":
      "هەموو پلەکان لە 15 تا 100 نیوتن/مم2 بە کۆنترۆڵی ڕێکخراوی بەرهەمهێنان.",
    "home.services.card2.title": "چەو و لم",
    "home.services.card2.body":
    ...
    "home.projects.body":
      "نەجمەدین ئار ئێم ئێکس پشتیوانی پڕۆژە سەکەنی و هوتێلی و فرەبەکارهێنان دەکات لە هەموو هەرێمی کوردستانی عێراق.",
    ...
    "about.hero.eyebrow": "دەربارەی ئێمە",
    "about.hero.title":
      "کۆمپانیایەک کە لەسەر متمانە و کوالێتی و گەیاندن دروست بووە",
    "about.hero.body":
      "کۆمپانیای نەجمەدین ئار ئێم ئێکس بەرجەستەی پڕۆفیشناڵی، نایابی و تەکنەلۆژیای پێشکەوتوو دەکات، کە تیایدا بەرهەمە چیمەنتۆییەکان بە کارایی و گشتگیرییەوە پێشکەش دەکەین بۆ پڕکردنەوەی پێداویستییە هەمەجۆرەکانی کڕیارانمان.",
    "about.story.eyebrow": "دەربارەی ئێمە",
    "about.story.title": "زیاتر لە دوو دەیە لە کارایی پشتڕاستکراو",
    "about.story.p1":
      "کۆمپانیای نەجمەدین ئار ئێم ئێکس لە ساڵی ٢٠٠٢ دامەزراوە، و یەکێکە لە کۆمپانیا پێشەنگەکان لە بەرهەمهێنان و دابینکردنی کۆنکریتی ئامادە و چەو و لم. ئەرکمان دابینکردنی بەرهەمی کوالێتی بەرزە بۆ کڕیارانمان. نهێنی پێشکەشکردنی کۆنکریتی ئامادەی کوالێتی بەرز لە چاودێریکردنی وردی کوالێتی و بەکارهێنانی کەرەستەی کوالێتی بەرزدایە.",
    "about.story.p2":
      "تیمەکەمان لە زیاتر لە ٢٠٠ کارمەندی شارەزا و پڕۆفیشناڵ لە پاشخانە جیاوازەکان پێکدێت، کە پابەندن بە مسۆگەرکردنی ڕەزامەندی باڵای کڕیاران و گەیاندنی کەرەستەکان لە کاتی گونجاودا، تەنانەت بۆ ناوچە دوورەدەستەکانیش.",
    "about.story.p3":
      "لە کۆمپانیای نەجمەدین ئار ئێم ئێکس، کۆنکریت تەنها تێکەڵەیەک نییە؛ بەڵکو چارەسەرێکی فرەمەبەستە کە بە توندی بە کڕیارانمانەوە دەمانبەستێتەوە و یارمەتیان دەدات لە جێبەجێکردنی پێداویستییەکانی پڕۆژەکانیان. بە پابەندبوونمان بە پێوەرە نێودەوڵەتییەکان، تەکنەلۆژیای پێشکەوتووی تێکەڵکردن بەکاردەهێنین.",
    ...
    "about.values.card1.title": "داهێنان و کوالێتی",
    "about.values.card1.body":
      "کوالێتییەکی بێوێنە لە ڕێگەی نوێترین تەکنیکەکانەوە دابین دەکەین. ئێمە نوێترین داهێنانەکان بەکاردەهێنین بۆ مسۆگەرکردنی لوتکەی کوالێتی و پتەوی.",
    "about.values.card2.title": "گەیاندن لە کاتی گونجاودا",
    "about.values.card2.body":
      "مسۆگەری گەیاندن لە کاتی دیاریکراودا و گەیاندن بۆ دوورەدەستترین ناوچەکان دەکەین. تیمی لۆجستی ئێمە گەیاندنی دەستبەجێ مسۆگەر دەکات بۆ پاراستنی خشتەی کاتی پڕۆژەکان.",
    "about.values.card3.title": "بەرەوپێشچوونی بەردەوام",
    "about.values.card3.body":
      "هەمیشە هەوڵی بەرەوپێشچوون دەدەین بۆ بەدەستهێنانی بەرهەمی کوالێتی بەرز. بەردەوام کار دەکەین بۆ باشترکردنی پرۆسەکانمان بۆ ئەوەی پێوەرەکانی پیشەسازییەکە تێپەڕێنین.",
    "about.qhse.eyebrow": "کوالێتی، تەندروستی، سەلامەتی و ژینگە",
    "about.qhse.title": "کوالێتی، تەندروستی، سەلامەتی و ژینگە (QHSE)",
    "about.qhse.body":
      "سەرکردایەتی نەجمەدین ئار ئێم ئێکس سیاسەتێکی توندی سەبارەت بە کوالێتی، تەندروستی، سەلامەتی و ژینگە داڕشتووە، کە مسۆگەری پێوەرە بەرزەکان دەکات لە بەرهەمهێنانی کۆنکریتدا و پێشینە دەدات بە کوالێتی و سەلامەتی. پەیڕەوی لە پراکتیکە بەردەوامەکان دەکەین بۆ کەمکردنەوەی کاریگەرییە ژینگەییەکان، بە تیشک خستنە سەر کارایی لە بەکارهێنانی سەرچاوەکان.",
    "about.qhse.item1": "پاراستنی ژینگە لە ڕێگەی ڕێگریکردن لە پیسبوون.",
    "about.qhse.item2":
      "گەیشتن بە ڕێژەی سفری ئەو پێکانانەی کە دەبنە هۆی بەفیڕۆدانی کات (پێکانی کار).",
    "about.qhse.item3": "پابەندبوون بە پێداویستییە یاساییەکان.",
    "about.qhse.item4": "بەرزکردنەوەی کارایی کارمەندان.",
    "about.qhse.item5":
      "هاندانی ڕێبازی هاوکاری تیم بۆ ڕێگریکردن لە کەموکوڕی و چارەسەرکردنی کێشەکان.",
    "about.qhse.item6": "دڵسۆزی لە کەمکردنەوەی پیسبوون و سەرپەرشتیکردنی ژینگە.",
    "about.qhse.item7":
      "جێبەجێکردنی داواکارییەکانی کڕیار لەگەڵ پابەندبوونی بەردەوام بۆ تێپەڕاندنی پێشبینییەکانیان.",
    "about.ops.eyebrow": "سەرمایەی مرۆیی",
    "about.ops.title": "سەرمایەی مرۆیی",
    "about.ops.body":
      "کرۆکی سەرکەوتنمان تیمی کارکردنمانە، ئەوان ئەو کۆڵەکە سەرەکییانەن کە پاڵنەرمانن بەرەو بەدەستهێنانی دەستکەوتەکانمان. تیمەکەمان بە گەورەترین و بەنرخترین سەرمایەی کۆمپانیا دادەنرێت، کە بەرجەستەی پابەندبوونی بەکۆمەڵ دەکات بە دەستپاکیی، ڕاستگۆیی، نایابی، بەرەوپێشبردنی بەردەوامی خود، ڕێزی دوولایەنە، کاری هەرەوەزی و بەرهەمهێنانی گشتگیر.",
    ...
    "about.ops.card2.body":
      "کادرێکی ڕاهێنراو کە بەرهەمهێنان و کوالێتی و دابەشکردن و هاوردەکردنی تەکنیکی پشتگیری دەکات.",
    ...
    "services.hero.body":
      "نەجمەدین ئار ئێم ئێکس پڕۆژەکان بە بەرهەمهێنانی کۆنکریتی ئامادە و دابینکردنی ماددە و ڕێنمایی تەکنیکی و لۆجستی باوەڕپێکراو پشتگیری دەکات.",
    "services.grid.eyebrow": "چی پێشکەش دەکەین",
    "services.grid.title":
      "بەرهەمهێنان و دابینکردن و پشتگیری تەکنیکی لە یەک سیستەمدا",
    "services.grid.body":
    ...
    "services.card2.title": "دابینکردنی چەو و لم",
    "services.card2.body":
      "دابینکردنی بەردەوامی چەو و لم بۆ پاراستنی کوالێتی تێکەڵە و جێگیریی کارکردن.",
    ...
    "services.card5.body":
      "لە نەجمەدین ئار ئێم ئێکس، سەرجەم بەرهەمەکانمان لە ناوخۆدا دروست دەکرێن، بۆ مسۆگەرکردنی کوالێتی بە ڕێژەی ١٠٠٪. تیشکخستنە سەرەکییەکانمان لەسەر بەرهەمهێنانی کۆنکریتی ئامادەیە بە هەموو پۆلەکانەوە، هەر لە 15 نیوتن/مم2 تاوەکو 100 نیوتن/مم2 بە هێزی بەرگەگرتنی پەستانی تەمەن 28 ڕۆژە.",
    "services.card6.title": "ڕاوێژی تەکنیکی",
    "services.card6.body":
      "پشتگیری تایبەتی لەلایەن تیمێکەوە کە هەڵسوکەوتی کۆنکریت و پێداویستیی شوێن دەزانن.",
    "services.standards":
      "پابەندین بە پێوەرە توندە نێودەوڵەتی و نیشتمانییەکان، لەوانە (EN · BS · ASTM · ACI · IS)، بۆ مسۆگەرکردنی کوالێتی کۆنکریتی نەجمەدین ئار ئێم ئێکس.",
    "services.process.eyebrow": "شێوازی کارکردن",
    "services.process.title": "ڕێگایەکی ڕوون لە داواکارییەوە بۆ گەیاندن",
    "services.process.body":
      "هاوردەکردن ئاسان دەکەین بە یەکخستنی پشکنینی تەکنیکی و پلانی بەرهەمهێنان و لۆجستی لە یەک زنجیرەدا.",
    ...
    "services.support.eyebrow": "پشتگیری تەکنیکی",
    ...
    "services.support.lead":
      "ئەگەر داواکارییەکە کۆنکریتی بەرزتووندی بێت یان هاوردەکردنی ورد بێت یان گەیاندن بۆ شوێنێکی دژوار، نەجمەدین ئار ئێم ئێکس ئامادەی وەڵامدانەوەی خێرا و ڕێکخراوە.",
    "projects.hero.eyebrow": "پڕۆژەکان",
    "projects.hero.title": "کارە دیارەکان لە سەرانسەری ناوچەکە",
    "projects.hero.body":
      "نەجمەدین ئار ئێم ئێکس بە دابینکردنی باوەڕپێکراو و هاوردەکردنی تەکنیکی و جێگیریی کوالێتی هاوبەشی پڕۆژە گەورەکان دەبێت.",
    "projects.grid.eyebrow": "پیشاندانی پڕۆژەکان",
    "projects.grid.title": "پڕۆژەی هەڵبژێردراو",
    "projects.grid.body":
      "ئەم پڕۆژانە قەبارە و جۆراوجۆریی کار و ئاڵۆزیی گەیاندن پیشان دەدەن کە تیمەکانمان ڕۆژانە پشتگیریان دەکەن.",
    ...
    "projects.excellence.eyebrow": "نایابی",
    "projects.excellence.title": "هێزی جێبەجێکردن لە پشتی هەر گەیاندنێکدا",
    "projects.excellence.body":
      "بە ئەزموونێکی بەرفراوان و تیمێکی هونەریی پسپۆڕەوە، نەجمەدین ئار ئێم ئێکس باڵادەستە لە دروستکردنی بەرهەمی کوالێتی بەرز و پاراستنی باشترین کارایی و ئاستی خزمەتگوزاری. پابەندبوونمان بە بەرەوپێشچوونی بەردەوام لە سەرجەم بەشەکاندا ڕێگەمان پێدەدات بە شێوەیەکی کاریگەر پێداویستییە پێشکەوتووەکانی بیناسازی مۆدێرن جێبەجێ بکەین.",
    "projects.ex1.title": "ئەزموونی بەرفراوان و تیمی پسپۆڕ",
    "projects.ex1.body":
      "ئەزموونی بەرفراوان و تیمی هونەریی پسپۆڕ بۆ مسۆگەرکردنی پەرەپێدانی بەرهەمی کوالێتی بەرز.",
    "projects.ex2.title": "پابەندبوون بە بەرەوپێشچوونی بەردەوام",
    "projects.ex2.body":
      "پابەندبوون بە بەرەوپێشچوونی بەردەوام، بەرزکردنەوەی کارایی و پاراستنی ئاستی خزمەتگوزاری نایاب.",
    "projects.ex3.title": "ڕێبازی ستراتیژی بۆ گەیاندن",
    "projects.ex3.body":
      "ڕێبازی ستراتیژی بۆ دابینکردنی پێداویستییەکانی پیشەسازی بە مەبەستی مامەڵەکردن لەگەڵ پێداویستییە پێشکەوتووەکانی کەرتی بیناسازیدا بە شێوەیەکی کاریگەر.",
    ...
    "clients.wall.body":
      "نەجمەدین ئار ئێم ئێکس پشتگیری ناوە گەورەکان دەکات لە پڕۆژە سەکەنی و میوانداری و تەندروستی و فرەبەکارهێناندا.",
    ...
    "clients.sector3.body":
      "گەشەپێدانەکان کە پێویستییان بە وردی تەکنیکی و ڕێکخراوی کات و متمانەی درێژخایەن هەیە.",
    "clients.proof.eyebrow": "تێپەڕاندنی پێشبینییەکان",
    "clients.proof.title": "بۆچی کڕیاران دەگەڕێنەوە",
    "clients.proof.body":
      "ئێمە بەرهەمی کوالێتی بەرز پێشکەش دەکەین کە پێشبینییەکانی کڕیار تێدەپەڕێنێت و بەتایبەتی بۆ پێداویستییەکانی هەر پڕۆژەیەک دیزاین کراوە. لە ڕێگەی پڕۆفیشناڵی لە خزمەتگوزاری کڕیاراندا، مسۆگەری گەیاندن لە کاتی خۆیدا و پەیوەندی کاریگەر لە سەرتاسەری پرۆسەکەدا دەکەین.",
    "clients.proof.local": "بەرهەمهێنانی ناوخۆ",
    "contact.hero.eyebrow": "پەیوەندی",
    "contact.hero.title": "با یەکەوە بنیات بنێین",
    "contact.hero.body":
      "زانیاری قەبارەی پڕۆژە و شوێن و پلەی پێویست و کاتی کار بنێرە، تیمی نەجمەدین ئار ئێم ئێکس هەنگاوی داهاتووت بۆ دەستنیشان دەکات.",
    ...
    "contact.form.subject": "داواکاریی پڕۆژە | نەجمەدین ئار ئێم ئێکس",
    ...
    "contact.faq.a2":
      "نەجمەدین ئار ئێم ئێکس پلەی 15 تا 100 نیوتن/مم2 دابین دەکات بەگوێرەی پێداویستیی پڕۆژە.",
    "contact.faq.q3": "ئایا پشتگیری تەکنیکی دەدەن؟",
    "contact.faq.a3":
